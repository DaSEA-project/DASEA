BEGIN ISOLATION LEVEL REPEATABLE READ, READ ONLY;
    ...
    \copy "versions" ("crate_id", "crate_size", "created_at", "downloads", "features", "id", "license", "num", "published_by", "updated_at", "yanked") TO 'data/versions.csv' WITH CSV HEADER



    \copy "dependencies" ("crate_id", "default_features", "features", "id", "kind", "optional", "req", "target", "version_id") TO 'data/dependencies.csv' WITH CSV HEADER
